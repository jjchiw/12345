			    	...
			    	if(isset($_POST['UserRecoveryForm'])) {
			    		...
			    		if($form->validate()) {
			    			...
			    			if(UserModule::sendMail($user->email,$subject,$message)){
								Yii::app()->user->setFlash('recoveryMessage',UserModule::t("Please check your email. An instructions was sent to your email address." . $user->email));
							}else{
								Yii::app()->user->setFlash('recoveryMessage',UserModule::t("Oops."));
