 ...
 * possibilites of yii큦 ActiveRecord implementation.
 *
 ...
 * saving our Model to the Database. Let큦 assume the following Relation:
 *
 * Post has:
 ...
 * the Posts with the id 5, 6, 7 and 10 get큦 added up to our new Category.
 *
 ...
 * further in the future, so only one query get큦 executed for the MANY_MANY
 * Table.
 *
